...
def link_section():
    ...
    st.sidebar.text("Here is my LinkedIn!")
    linkedin_link = f'<a href="{info.my_linkedin_url}"><img src="{info.linkedin_image_url}" alt="LinkedIn" width="75" height="75"></a>'
    st.sidebar.markdown(linkedin_link, unsafe_allow_html=True)

    st.sidebar.text("Here is my social media!")
    my_github_url = f'<a href="{info.my_github_url}"><img src="{info.github_image_url}" alt="Github" width="65" height="65"></a>'
    st.sidebar.markdown(my_github_url, unsafe_allow_html=True)

    st.sidebar.text("Here is my email!")
